...
Thank you for your interest in `loopback-informixdb`, an open source project
administered by StrongLoop (an IBM Company).

Contributing to `loopback-informixdb` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/loopback-informixdb)
